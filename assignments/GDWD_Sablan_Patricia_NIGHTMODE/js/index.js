...
function nightModeHandler(){
  ...
  heading1.classList.toggle('content-day');
  heading1.classList.toggle('content-night');

  heading2.classList.toggle('content-day');
  heading2.classList.toggle('content-night');

  heading3.classList.toggle('content-day');
  heading3.classList.toggle('content-night');
